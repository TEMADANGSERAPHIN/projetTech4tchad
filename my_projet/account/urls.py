...
from account.views import (
    sing_in, singin, singinD, singinS, sing_up, dashboard, log_out, contact_list, employes_lists, recu_lists,
...
urlpatterns = [
    ...
    path('homesubit.html', views.homesubit, name='homesubit'),
    ...
    path('recu_lists', recu_lists, name='recu_lists'),
    
    path('recu_listAg', views.recu_listAg, name='recu_listAg'),
    path('recu_listAgs', views.recu_listAgs, name='recu_listAgs'),
    ...
    path('recu_listBans', views.recu_listBans, name='recu_listBans'),
    path('add_recuBan', views.add_recuBan, name='add_recuBan'),
    path('show_banque/<banque_id>', views.show_banque, name='show_banque'),
    ...
    # path('superviseur_list', views.superviseur_list, name='superviseur_list'),
    # path('add_superviseur', views.add_superviseur, name='add_superviseur'),
    # path('show_superviseur/<superviseur_id>', views.show_superviseur, name='show_superviseur'),
    # path('delete_superviseur/<superviseur_id>', views.delete_superviseur, name='delete_superviseur'),
    # path('update_superviseur/<superviseur_id>', views.update_superviseur, name='update_superviseur'),
    
    
    
    # path('directeur_list', directeurs_list, name='directeur_list'),
